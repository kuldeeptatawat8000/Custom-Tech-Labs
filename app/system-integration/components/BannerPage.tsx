...
export default function BannerPage() {
    return (
        <>
            <section className="w-full md:w-[95%] lg:w-[89%] mx-auto flex flex-col justify-center gap-5 md:gap-3 px-4 sm:px-6 md:px-10 lg:px-12 py-6 md:py-12 lg:py-0 text-center md:text-start bg-no-repeat bg-right bg-contain lg:bg-cover md:bg-[url('/system/hero.png')] min-h-screen md:min-h-125 lg:h-112.5 xl:h-130">
                ...
                {/* Paragraph 2 */}
                <p className="md:w-1/2 text-[15px] sm:text-[20px] md:text-[12px] lg:text-[15px] xl:text-[17px] leading-relaxed">
                    Because disconnected systems don’t just slow you
                    down, they create problems you shouldn’t have to
                    manage.
                </p>
