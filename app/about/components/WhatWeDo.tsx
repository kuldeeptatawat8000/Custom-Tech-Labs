                ...
                <div className="flex w-full flex-wrap flex-col md:flex-row gap-10 justify-center items-center">
                    {
                        services.map((item, idx) => (
                            <div key={idx} className="md:w-107.5 flex flex-col justify-between items-start py-5 w-full px-5 shadow-xl shadow-gray-200 bg-[#f5f5f5] h-39.5 border-l-14 border-[#eff430] ">
